...
function initializeFooter() {
    ...
    if (!footerElement) {
        ...
        console.error(
            "Hangar Play: no se encontró #hangar-footer."
        );
...
function loadSavedLocation() {
    ...
    try {
        ...
        console.warn(
            "Hangar Play: no se pudo cargar la localidad guardada.",
            error
        );
...
function saveLocation() {
    ...
    try {
        ...
        console.warn(
            "Hangar Play: no se pudo guardar la localidad.",
            error
        );
...
async function updateWeather() {
    ...
    try {
        ...
        console.error(
            "Hangar Play: error al obtener el clima.",
            error
        );
        ...
        /*
           Aunque falle la API meteorológica,
           la hora local continúa funcionando.
        */
...
function getWeatherStateFromCode(
    ...
    */
    ...
    /*
       TORMENTA / NIEVE / CONDICIONES SEVERAS
    */
...
function updateWeatherBackground() {
    ...
    /*
       Eliminamos todas las clases meteorológicas
       antes de colocar la nueva.
    */
...
function updateLocalClock() {
    ...
    try {
        ...
        console.error(
            "Hangar Play: error mostrando la hora local.",
            error
        );
...
function setupLocationSearch() {
    ...
    if (
        ...
        console.error(
            "Hangar Play: faltan elementos del buscador de localidad."
        );
...
async function searchLocations() {
    ...
    try {
        ...
        console.error(
            "Hangar Play: error buscando localidad.",
            error
        );
